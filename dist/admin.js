...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("\"use strict\";\n\n__webpack_require__(2);\n\nvar _detectDomReady = __webpack_require__(299);\n\nvar _detectDomReady2 = _interopRequireDefault(_detectDomReady);\n\nvar _superagent = __webpack_require__(301);\n\nvar _superagent2 = _interopRequireDefault(_superagent);\n\nvar _superagentPromise = __webpack_require__(307);\n\nvar _superagentPromise2 = _interopRequireDefault(_superagentPromise);\n\nvar _setupIframeResizer = __webpack_require__(308);\n\nvar _setupIframeResizer2 = _interopRequireDefault(_setupIframeResizer);\n\nvar _communitySlugUpdater = __webpack_require__(309);\n\nvar _communitySlugUpdater2 = _interopRequireDefault(_communitySlugUpdater);\n\nvar _options = __webpack_require__(310);\n\nvar _options2 = _interopRequireDefault(_options);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar request = (0, _superagentPromise2.default)(_superagent2.default, Promise); /* global ajaxurl */\n\nvar hubchatHost = hubchatConfig.serviceHost;\nvar nonce = hubchatConfig.nonce;\n\n(0, _detectDomReady2.default)(function () {\n    var setupIframe = document.getElementsByClassName(\"hubchat-admin-iframe\").item(0);\n\n    (0, _setupIframeResizer2.default)({\n        win: window,\n        setupIframe: setupIframe,\n        hubchatHost: hubchatHost\n    });\n\n    var finishInstantiation = function finishInstantiation() {\n        setupIframe.removeEventListener(\"load\", finishInstantiation);\n\n        var setupWin = setupIframe.contentWindow;\n\n        (0, _communitySlugUpdater2.default)({\n            win: window,\n            setupWin: setupWin,\n            hubchatHost: hubchatHost,\n            options: (0, _options2.default)({ request: request, ajaxUrl: ajaxurl, nonce: nonce })\n        });\n    };\n\n    setupIframe.addEventListener(\"load\", finishInstantiation);\n});\n\n/*****************\n ** WEBPACK FOOTER\n ** ./src/js/admin/index.js\n ** module id = 0\n ** module chunks = 1\n **/\n//# sourceURL=webpack:///./src/js/admin/index.js?");
...
/***/ function(module, exports) {
	...
	eval("/**\n * Promise wrapper for superagent\n */\n\nfunction wrap(superagent, Promise) {\n  /**\n   * Request object similar to superagent.Request, but with end() returning\n   * a promise.\n   */\n  function PromiseRequest() {\n    superagent.Request.apply(this, arguments);\n  }\n\n  // Inherit form superagent.Request\n  PromiseRequest.prototype = Object.create(superagent.Request.prototype);\n\n  /** Send request and get a promise that `end` was emitted */\n  PromiseRequest.prototype.end = function(cb) {\n    var _end = superagent.Request.prototype.end;\n    var self = this;\n\n    return new Promise(function(accept, reject) {\n      _end.call(self, function(err, response) {\n        if (cb) {\n          cb(err, response);\n        }\n\n        if (err) {\n          err.response = response;\n          reject(err);\n        } else {\n          accept(response);\n        }\n      });\n    });\n  };\n\n  /** Provide a more promise-y interface */\n  PromiseRequest.prototype.then = function(resolve, reject) {\n    var _end = superagent.Request.prototype.end;\n    var self = this;\n\n    return new Promise(function(accept, reject) {\n      _end.call(self, function(err, response) {\n        if (err) {\n          err.response = response;\n          reject(err);\n        } else {\n          accept(response);\n        }\n      });\n    }).then(resolve, reject);\n  };\n\n  /**\n   * Request builder with same interface as superagent.\n   * It is convenient to import this as `request` in place of superagent.\n   */\n  var request = function(method, url) {\n    return new PromiseRequest(method, url);\n  };\n\n  /** Helper for making an options request */\n  request.options = function(url) {\n    return request('OPTIONS', url);\n  }\n\n  /** Helper for making a head request */\n  request.head = function(url, data) {\n    var req = request('HEAD', url);\n    if (data) {\n      req.send(data);\n    }\n    return req;\n  };\n\n  /** Helper for making a get request */\n  request.get = function(url, data) {\n    var req = request('GET', url);\n    if (data) {\n      req.query(data);\n    }\n    return req;\n  };\n\n  /** Helper for making a post request */\n  request.post = function(url, data) {\n    var req = request('POST', url);\n    if (data) {\n      req.send(data);\n    }\n    return req;\n  };\n\n  /** Helper for making a put request */\n  request.put = function(url, data) {\n    var req = request('PUT', url);\n    if (data) {\n      req.send(data);\n    }\n    return req;\n  };\n\n  /** Helper for making a patch request */\n  request.patch = function(url, data) {\n    var req = request('PATCH', url);\n    if (data) {\n      req.send(data);\n    }\n    return req;\n  };\n\n  /** Helper for making a delete request */\n  request.del = function(url) {\n    return request('DELETE', url);\n  };\n\n  // Export the request builder\n  return request;\n}\n\nmodule.exports = wrap;\n\n\n/*****************\n ** WEBPACK FOOTER\n ** ./~/superagent-promise/index.js\n ** module id = 307\n ** module chunks = 1\n **/\n//# sourceURL=webpack:///./~/superagent-promise/index.js?");

/***/ },
/* 308 */
/***/ function(module, exports) {

	eval("\"use strict\";\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar createSetupIframeResizer = function createSetupIframeResizer(_ref) {\n    var win = _ref.win;\n    var setupIframe = _ref.setupIframe;\n    var hubchatHost = _ref.hubchatHost;\n\n    win.addEventListener(\"message\", function (event) {\n        if (!messageEventIsAllowed(event)) {\n            return;\n        }\n        setupIframe.style.height = event.data.documentHeight + \"px\";\n    });\n\n    function messageEventIsAllowed(event) {\n        var setupWin = setupIframe.contentWindow;\n\n        return event.data.type === \"documentHeightChanged\" && typeof event.data.documentHeight !== \"undefined\" && event.source === setupWin && event.origin === hubchatHost;\n    }\n};\n\nexports.default = createSetupIframeResizer;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./src/js/admin/setupIframeResizer.js\n ** module id = 308\n ** module chunks = 1\n **/\n//# sourceURL=webpack:///./src/js/admin/setupIframeResizer.js?");

/***/ },
/* 309 */
/***/ function(module, exports) {

	eval("\"use strict\";\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar createCommunitySlugUpdater = function createCommunitySlugUpdater(_ref) {\n    var win = _ref.win;\n    var setupWin = _ref.setupWin;\n    var hubchatHost = _ref.hubchatHost;\n    var options = _ref.options;\n\n    win.addEventListener(\"message\", function (event) {\n        if (!messageEventIsAllowed(event)) {\n            return;\n        }\n        options.setCommunitySlug(event.data.communitySlug).then(postResult(event.data.id, true)).catch(postResult(event.data.id, false));\n    });\n\n    function messageEventIsAllowed(event) {\n        return event.data.communitySlug && event.source === setupWin && event.origin === hubchatHost;\n    }\n\n    function postResult(id, success) {\n        return function () {\n            setupWin.postMessage({ id: id, success: success }, hubchatHost);\n        };\n    }\n};\n\nexports.default = createCommunitySlugUpdater;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./src/js/admin/communitySlugUpdater.js\n ** module id = 309\n ** module chunks = 1\n **/\n//# sourceURL=webpack:///./src/js/admin/communitySlugUpdater.js?");

/***/ },
/* 310 */
/***/ function(module, exports) {

	eval("\"use strict\";\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nfunction createOptions(_ref) {\n    var request = _ref.request;\n    var ajaxUrl = _ref.ajaxUrl;\n    var nonce = _ref.nonce;\n\n    function setCommunitySlug(slug) {\n        return new Promise(function (resolve, reject) {\n            request.post(ajaxUrl).send(\"action=update_hubchat_community_slug\").send(\"slug=\" + slug).send(\"_ajax_nonce=\" + nonce).end(function (err, response) {\n                if (err || response.text === \"0\" || response.text === \"-1\") {\n                    reject(err);\n                } else {\n                    resolve();\n                }\n            });\n        });\n    }\n\n    return { setCommunitySlug: setCommunitySlug };\n}\n\nexports.default = createOptions;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./src/js/options.js\n ** module id = 310\n ** module chunks = 1\n **/\n//# sourceURL=webpack:///./src/js/options.js?");
